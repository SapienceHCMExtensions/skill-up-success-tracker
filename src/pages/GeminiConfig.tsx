...
import { Key, Save, Check, ArrowLeft } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground">Gemini AI Configuration</h1>
          <p className="text-muted-foreground">Configure the Gemini AI API key for generating AI content</p>
        </div>
      </div>
      ...
      <div className="grid gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>AI Content Generation Features</CardTitle>
            <CardDescription>
